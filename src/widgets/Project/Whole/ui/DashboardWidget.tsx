        ...
        return (
            <main className="bg-white w-full max-w-[1000px] mx-auto py-4 mb-10 px-4 md:px-8 lg:px-12 overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row gap-4 mb-6 px-0 md:px-2 lg:px-0 max-w-full">
                    <TeamSummary num={warningTeams}>
                        <More onClick={handleWarningTeamsClick} />
                    </TeamSummary>
                    <ToDoSummary num={progressAssignments}>
                        <More onClick={handleAssignmentClick} />
                    </ToDoSummary>
                </div>

                <NextSubmit chartData={chartData ?? undefined} />
            </main>
        );
    }
