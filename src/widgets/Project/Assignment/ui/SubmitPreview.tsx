...
export function SubmitPreview({ fileUrl }: Props) {
    return (
        <div className="w-full border-1 border-gray-10 rounded-lg h-110 flex flex-col">
            <h3 className="text-heading-m text-secondary-80 mt-8 ml-4 sm:ml-8 mb-4 flex-shrink-0">제출물 미리보기</h3>
            <div className="flex-1 overflow-auto scrollbar-thin px-4 sm:px-8 pb-8 flex justify-center">
