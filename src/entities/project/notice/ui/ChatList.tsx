...
interface Props {
    messages: Message[];
    DownloadButton?: React.ComponentType<{ fileName: string; fileUrl: string }>;
}

export function ChatList({ messages, DownloadButton }: Props) {
    ...
    const renderMessage = (message: Message, index: number, messagesArray: Message[]) => {
