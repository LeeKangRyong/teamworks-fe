...
interface Props {
    submitsData?: SubmitData[];
    renderActions?: (submit: SubmitData) => React.ReactNode;
}

export function ParticipantSubmitList({ submitsData, renderActions }: Props) {
    const router = useRouter();
    const params = useParams();
    const projectId = params.id;
    const assignmentId = params.assignmentId;

    const handleSubmit = (submitId: number) => {
