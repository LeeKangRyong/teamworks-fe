 ...
 * 무임승차 팀 필터링
 */
export const getWarningTeams = (teams: Team[]): Team[] => {
 ...
 * 진행중인 과제 필터링
 */
export const getProgressAssignments = (assignments: Assignment[]): Assignment[] => {
 ...
 * 대시보드 통계 계산
 */
export const calculateDashboardStats = (teams: Team[], assignments: Assignment[]): DashboardStats => {
