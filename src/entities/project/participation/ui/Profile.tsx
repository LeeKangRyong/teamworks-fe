...
export function Profile({ name, team, status }: Props) {
    return (
        <article className="flex flex-row gap-2 border-gray-10 border-1 rounded-lg w-full px-3 py-4 items-center">
            <Image src={profile} alt="profile" className="w-18 h-18 flex-shrink-0" />
