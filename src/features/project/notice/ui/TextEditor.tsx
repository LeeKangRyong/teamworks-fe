...
export function TextEditor({ onChange }: Props) {
    ...
    const headingModalRef = useRef<HTMLDivElement>(null);
    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent) => {
            ...
            if (showHeadingModal &&
                ...
                !headingModalRef.current.contains(event.target as Node) &&
    ...
    const parseMarkdown = (markdown: string) => {
        ...
        html = html.replace(/(<li[\s\S]*?<\/li>)/g, '<ul class="!list-disc !pl-5 !my-2">$1</ul>');
    ...
    const handleHeadingClick = (headingValue: string) => {
        ...
        const htmlContent = `
            ...
            <head>
                ...
                <style>
                    ...
                    h1 { color: #2c3e50; border-bottom: 2px solid #eee; padding-bottom: 10px; font-size: 2rem !important; font-weight: bold !important; }
                    h2 { color: #2c3e50; font-size: 1.5rem !important; font-weight: bold !important; }
                    h3 { color: #2c3e50; font-size: 1.25rem !important; font-weight: bold !important; }
