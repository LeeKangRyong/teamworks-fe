...
export function Search({ value = "", onChange, placeholder = "팀 참여자를 선택해주세요", hasError = false, onFocus, onBlur }) {
    ...
    return (
        <div role="button" 
            className={`bg-secondary-3 rounded-lg p-3 transition-colors flex flex-row ${
                hasError 
