    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                <Image src={sort} alt="sort" className="w-4 h-4 ml-2 flex-shrink-0" />
                    ...
                    <div>
                        {sortOptions.map((option, index) => (
                            <button
                                ...
                                className="w-full px-3 py-3 text-left text-body-m bg-secondary-3 hover:bg-secondary-60 transition-colors duration-150 flex items-center justify-center group first:rounded-t-lg last:rounded-b-lg whitespace-nowrap"
                            >
